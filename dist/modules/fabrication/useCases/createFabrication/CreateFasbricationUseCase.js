...
exports.CreateFabricationUseCase = void 0;
...
let CreateFabricationUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (fabricationDate >= (0, _moment.default)().utc().format()) {
      throw new _AppError.AppError("invalid manufacturing date");
    }
    if (validadeDate <= (0, _moment.default)().utc().format()) {
      throw new _AppError.AppError("invalid expiration date.");
    }
...
exports.CreateFabricationUseCase = CreateFabricationUseCase;