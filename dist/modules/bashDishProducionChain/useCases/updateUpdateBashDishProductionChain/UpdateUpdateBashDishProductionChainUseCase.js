...
exports.UpdateBashDishProductionChainUseCase = void 0;
...
let UpdateBashDishProductionChainUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(data) {
    ...
    if (companyExists.companytype.type !== "restaurant") {
      throw new _AppError.AppError("the type of company informed is not allowe");
    }
...
exports.UpdateBashDishProductionChainUseCase = UpdateBashDishProductionChainUseCase;